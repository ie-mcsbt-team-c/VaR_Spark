...
instruments_returns = pd.read_csv("https://raw.githubusercontent.com/ie-mcsbt-team-c/VaR_Spark/master/instrument_returns.csv")
...
featurize_returns = pd.DataFrame(featurize(factors_returns))
